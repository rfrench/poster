...
module.exports = (function() { 'use strict';
	...
	function upload(uploadUrl, parsedUri, uploadOptions, size, fileName, callback) {
		var form = getMultipartForm(uploadOptions.fields, uploadOptions.fileId, fileName);
	...
	* on the remote web server of if maxFileSize is provided, we can bail out if it's too large */
	...
	function getMultipartForm(fields, fileFieldName, fileName) {
		var form = '';
		if (fields) {
